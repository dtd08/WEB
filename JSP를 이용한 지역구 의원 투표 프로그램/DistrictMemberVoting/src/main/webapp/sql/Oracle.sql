...
select v_name
	...
	, (TRUNC(MONTHS_BETWEEN(TRUNC(SYSDATE), TO_DATE(TO_NUMBER(substr(('19' ||v_jumin), 1, 8)),'YYYYMMDD')) / 12)) as v_age
...
select TO_NUMBER(substr(('19' ||v_jumin), 1, 8)) from tbl_vote_202005;
